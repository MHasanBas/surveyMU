...
<body style="background-color: #d9d9d9">
        ...
        <nav class="navbar navbar-custom navbar-expand-lg shadow-lg">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between ps-4" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="indexAdmin.php" style="border-bottom: solid white;">Beranda</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="content-container shadow-lg">
        ...
        <p>Sistem Survey Kepuasan Pelanggan Politeknik Negeri Malang merupakan sarana untuk mengukur tingkat kepuasan
            seluruh pemangku kepentingan polinema, mulai dari mahasiswa, orang tua/wali mahasiswa, alumni, mitra
            kerjasama, hingga pengguna lulusan polinema.</p>
        <a class="btn btn-explore rounded-pill px-4 py-2" href="Editsurvey.php">Memulai</a>
    </div>

    <div class="content2-container shadow-lg d-flex flex-column flex-md-row gap-5 p-5">
        <div class="container rounded-4 p-2 clickable" style="background-color: #d9d9d9"
            onclick="window.location.href='rekapjawaban.php';">
            <p class="fs-2"><b>Rekap Jawaban</b><span class="red-span"></span></p>
            <img src="../assets/img2.png" class="img-fluid" style="height: 20rem" alt="" />
            <p class="fs-3 text-left">Tampilkan Rekap jawaban Survey Anda</p>
            <p class="text-left">Ini berisi simpulan riwayat dari survey yang merupakan rangkuman singkat dari hasil
                yang ditemukan dalam sebuah survei yang telah dilakukan sebelumnya.</p>
        </div>
        <div class="container rounded-4 p-2 clickable" style="background-color: #d9d9d9"
            onclick="window.location.href='editsurvey.php';">
            <p class="fs-2"><b>Edit Survey</b><span class="red-span"></span></p>
            <img src="../assets/img3.png" class="img-fluid" style="height: 20rem" alt="" />
            <p class="fs-3 text-left">Edit Survey yang akan diisi user</p>
            <p class="text-left">Ini berisi kuesioner tentang penilaian Anda terhadap beberapa aspek yang disediakan
                Polinema.</p>
        </div>
    </div>
