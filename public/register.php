...
<body style="background-color: #d9d9d9">
    ...
    <div class="d-flex flex-column flex-md-row" style="min-height: 100vh">
        <div class="d-flex flex-column justify-content-center align-items-center"
            ...
            <form action="register.php" method="post" style="width: 100%; max-width: 500px;">
                <div class="mb-3">
                ...
                <button type="submit" class="btn rounded-pill w-100" style="background-color: #4e73df; color: white">Register</button>
                <div class="mt-3 text-center">
                    <span>Sudah punya akun? <a href="login.php" style="color: blue">Login</a></span>
                </div>
            </form>
        </div>
        <div style="flex: 1; background-color: #ffffff">
            <div class="text-center d-flex justify-content-center align-items-center"
                ...
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); border-radius: inherit">
                </div>

                <!-- Centered Text -->
                <div style="position: relative; z-index: 1; color: white; font-weight: bold; font-size: 2rem">Sistem Survey Kepuasan Pelanggan<br />Politeknik Negeri Malang</div>
            </div>
        </div>
    </div>
