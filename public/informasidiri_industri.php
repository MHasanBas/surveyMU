    ...
    <div class="d-flex" style="height: 100vh">
        <div class="d-flex flex-column justify-content-center align-items-center"
            ...
            <form style="width: 80%" action="save_responden.php" method="post">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="Responden Tanggal"
                        name="responden_tanggal" />
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_nama"
                        name="responden_nama" />
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_jabatan"
                        name="responden_jabatan" />
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_perusahaan"
                        name="responden_perusahaan" />
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_email"
                        name="responden_email" />
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_hp"
                        name="responden_hp" />
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_kota"
                        name="responden_kota" />
                </div>
                <input hidden type="text" name="survey_id" class="form-control rounded-pill"
                    value="<?php echo $row['survey_id'] ?>" />
                <input hidden type="text" name="survey_jenis" class="form-control rounded-pill" value="Industri" />
