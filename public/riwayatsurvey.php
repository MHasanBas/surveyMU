...
<body style="background-color: #d9d9d9">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between ps-4" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="riwayatsurvey.php" style="border-bottom: solid white">Riwayat
                                Survey</a>
                        </li>
                    </ul>
    ...
    <div class="text-center p-3 mx-auto" style="width: 50%; color: #2c4182">
        <p><span class="mb-1 fs-2">Pilih jenis</span> <span class="mb-2 fs-3"> untuk melihat Riwayat Pengisian
                Survey</span></p>

        <img src="../assets/img3.png" alt="Image" class="img-fluid mt-3" />
        <select class="form-select mt-3" style="background-color: #cecfd5; border-radius: 10px" id="pilih_jenis_survey">
            ...
            <?php foreach ($kategori as $key => $row): ?>
                <?php if ($survey_jenis == 'Mahasiswa'): ?>
                    <option value="<?= $key + 2 ?>"><?= $row['kategori_nama'] ?></option>
    ...
    <script>
        document.getElementById("pilih_jenis_survey").addEventListener("change", function () {
            ...
            if (selectedValue != "") {
                window.open("riwayatsurvey" + selectedValue + ".php", "_blank");
            }
        });
    </script>
</body>
