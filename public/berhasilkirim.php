...
<html lang="en">
    ...
    <body style="background-color: #eaeaea">
        <header>
            <nav class="navbar navbar-custom navbar-expand-lg shadow-lg">
                <div class="container">
                    ...
                    <span class="navbar-text ml-3 text-white" style="font-weight: 500"> Survey Kepuasan Pelanggan Polinema </span>
        ...
        <div class="container text-center p-3">
            ...
            <p style="color: #2c4182" class="fs-3">Yeayy! Survey Berhasil di Kirim</p>
            <a href="indexUser.php" class="btn btn-primary btn-lg rounded-pill" style="background-color: #4e73df; color: white">Beranda</a>
        </div>
