    ...
    <div class="d-flex" style="height: 100vh">
        <div class="d-flex flex-column justify-content-center align-items-center"
            ...
            <form style="width: 80%" action="save_responden.php" method="post">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_nip" name="responden_nip"/>
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_nama" name="responden_nama"/>
                </div>
                <div class="mb-3">
                    <input type="text" class="form-control rounded-pill" placeholder="responden_unit" name="responden_unit"/>
                </div>
                <input hidden type="text" name="survey_id" class="form-control rounded-pill" value="<?php echo $row['survey_id'] ?>" />
                <input hidden type="text" name="survey_jenis" class="form-control rounded-pill" value="Dosen" />
